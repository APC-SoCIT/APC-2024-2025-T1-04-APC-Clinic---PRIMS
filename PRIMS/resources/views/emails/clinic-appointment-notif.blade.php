                    ...
                    <tr>
                        <td style="padding:30px; color:#333;">
                            ...
                            <p style="font-size:16px; margin-bottom:10px;">
                                <strong>{{ $appointment->patient->first_name }} {{ $appointment->patient->middle_initial }}. {{ $appointment->patient->last_name }}</strong> 
                            ...
                            <p style="font-size:15px; margin-top:20px; margin-bottom:30px; color:#555;">
                                Kindly review the appointment in the PRIMS system.
                            </p>

                            <div style="text-align:center;">
                                <a href="{{ url('/nurse/appointments') }}" 
                                   style="background-color:#2a7be4; color:white; text-decoration:none; 
